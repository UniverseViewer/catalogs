# Universe Viewer catalogs

Here is a summary of currently supported catalogs for [Universe Viewer](https://universeviewer.com).

## Setup

Pick up a release and install it in your Universe Viewer installation, under `catalogs` folder.

## Supported catalogs list

In this repository, you will find tools and instructions to convert the following catalogs to Universe Viewer format.
...
- [More details here](/vii_221_iraspscz/README.md)
...
- [More details here](/vii_259_6dF/README.md)
...
- [More details here](/vii_258/README.md)
...
- [More details here](/twomassrsc/README.md)
...
- [More details here](/sdss_qso/README.md)
...
- [More details here](/milliquas/README.md)
...
- [More details here](/quaia/README.md)
...
- [More details here](/agngal_desi_dr1/README.md)
